...
public class MealsUtil {
    ...
    public static final Integer userId = SecurityUtil.authUserId();
    ...
    public static List<MealTo> getFilteredByDateAndTimeTos(Collection<Meal> meals
            , int caloriesPerDay
            , String startDate
            , String endDate
            , String startTime
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
        ...
        return meals.stream()
                .filter(meal -> DateTimeUtil.isBetweenDate(meal.getDate(), sd, ed))
                .filter(meal -> DateTimeUtil.isBetweenHalfOpen(meal.getTime(), st, et))
